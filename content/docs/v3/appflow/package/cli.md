...
<img src="/docs/v3/img/pro/cli/cli-security-profile-list.png" class="browser" />
<img src="/docs/v3/img/pro/cli/cli-environments-list.png" class="browser" />
<img src="/docs/v3/img/pro/cli/cli-native-config-list.png" class="browser" />


For the Target Platform, it is one of the strings identifying the platform in the Applflow Package Build Form.

<img src="/docs/v3/img/pro/cli/cli-target-platform.png" class="browser" />
